...
func (LVMVolumeConfigV1Alpha1) Doc() *encoder.Doc {
	...
	doc.AddExample("", exampleLVMVolumeConfigStriped())
	...
	doc := &encoder.Doc{
		...
		Fields: []encoder.Doc{
			...
			},
			{
				...
				Type:        "int",
				Note:        "",
				Description: "Number of stripes for striped volumes.\nRequired and must be greater than 1 if type is striped.",
				Comments:    [3]string{"" /* encoder.HeadComment */, "Number of stripes for striped volumes." /* encoder.LineComment */, "" /* encoder.FootComment */},
			},
			{
				Name:        "mirrors",
				Type:        "int",
				Note:        "",
				Description: "Number of mirrors for mirrored volumes.\nRequired and must be greater than 0 if type is mirror.",
				Comments:    [3]string{"" /* encoder.HeadComment */, "Number of mirrors for mirrored volumes." /* encoder.LineComment */, "" /* encoder.FootComment */},
			},
			{
				Name:        "filesystem",
				Type:        "FilesystemSpec",

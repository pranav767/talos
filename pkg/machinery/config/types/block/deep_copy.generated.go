...
func (o *LVMVolumeConfigV1Alpha1) DeepCopy() *LVMVolumeConfigV1Alpha1 {
	...
	if o.LogicalVolumes != nil {
		...
		for i2 := range o.LogicalVolumes {
			...
			if o.LogicalVolumes[i2].Stripes != nil {
				cp.LogicalVolumes[i2].Stripes = new(int)
				*cp.LogicalVolumes[i2].Stripes = *o.LogicalVolumes[i2].Stripes
			}
			if o.LogicalVolumes[i2].Mirrors != nil {
				cp.LogicalVolumes[i2].Mirrors = new(int)
				*cp.LogicalVolumes[i2].Mirrors = *o.LogicalVolumes[i2].Mirrors
			}
